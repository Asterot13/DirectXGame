...
void BumpMappingDemo::render()
{
	...
	GraphicsEngine::get()->getRenderSystem()->getImmidiateDeviceContext()->clearRenderTargetColor(this->m_swap_chain,
		0, 0.3f, 0.4f, 1);
	...
	GraphicsEngine::get()->getRenderSystem()->getImmidiateDeviceContext()->clearDepthStencil(this->m_swap_chain
	);
